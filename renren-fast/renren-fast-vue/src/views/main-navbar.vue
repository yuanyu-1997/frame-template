  ...
  <nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
    <div class="site-navbar__header">
      <h1 class="site-navbar__brand" @click="$router.push({ name: 'home' })">
        ...
        <a class="site-navbar__brand-mini" href="javascript:">展开</a>
      </h1>
    </div>
    <div class="site-navbar__body clearfix">
      ...
      <el-menu
        ...
        <el-menu-item index="2">
          <el-badge value="hot">
            <a href="https://yuanyu.blog.csdn.net/" target="_blank">我的博客</a>
          </el-badge>
        </el-menu-item>
        <el-menu-item index="3">
          <a href="https://github.com/yuanyu1997" target="_blank">我的GitHub</a>
        </el-menu-item>
        <el-submenu index="4">
