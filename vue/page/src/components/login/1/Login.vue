        ...
        <div class="login">
            ...
            <div class="item">
                <label>
                    ...
                    <span>用户名</span>
                    <input maxlength="16" type="text" placeholder="   请输入用户名" v-model="loginForm.username">
                </label>
            </div>
            <div class="item">
                <label>
                    <span>
                        <svg class="icon" height="20" p-id="4677" t="1586443029761"
                             version="1.1" viewBox="0 0 1024 1024" width="20" xmlns="http://www.w3.org/2000/svg"><path
                                ...
                                fill="#ffffff" p-id="4679"></path>
                        </svg>
                    </span>
                    <span>密码</span>
                    <input maxlength="16" type="password" placeholder="   请输入密码" v-model="loginForm.password">
                </label>
            </div>
            <div class="loginBtn" @click="handLogin">
                <span>登陆</span>
            </div>
        </div>
    </div>
...
<script>
    ...
    // https://www.jianshu.com/p/ef1582794a79
    export default {
        data() {
            return {
                loginForm: {
