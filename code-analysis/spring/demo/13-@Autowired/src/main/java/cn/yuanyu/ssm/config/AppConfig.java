 ...
 * 			不支持@Primary、@Qualifier，没有required=false的功能
 * 		@Inject:
...
public class AppConfig {
    ...
    UserMapper userMapper(){
        ...
        userMapper.setLable("six");
        System.out.println("mapper => "+userMapper);
        return userMapper;
    }

    // https://blog.csdn.net/ado1986/article/details/49334791

    @Bean("a")
    UserMapper a(){
        UserMapper userMapper = new UserMapper();
        userMapper.setLable("a");
        System.out.println("mapper => "+userMapper);
        return userMapper;
    }
